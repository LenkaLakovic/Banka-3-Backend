...
const file_user_user_proto_rawDesc = "" +
	...
	"\x0eUpdateEmployee\x12\x1b.user.UpdateEmployeeRequest\x1a\x19.user.GetEmployeeResponse\x120\n" +
...
var file_user_user_proto_goTypes = []any{
	...
	(*Client)(nil),                        // 16: user.Client
	(*GetClientsRequest)(nil),             // 17: user.GetClientsRequest
	(*GetClientsResponse)(nil),            // 18: user.GetClientsResponse
	(*UpdateClientRequest)(nil),           // 19: user.UpdateClientRequest
	(*UpdateClientResponse)(nil),          // 20: user.UpdateClientResponse
	(*GetEmployeesRequest)(nil),           // 21: user.GetEmployeesRequest
	(*GetEmployeesResponse)(nil),          // 22: user.GetEmployeesResponse
	(*GetEmployeeByIdRequest)(nil),        // 23: user.GetEmployeeByIdRequest
	(*GetEmployeeByEmailRequest)(nil),     // 24: user.GetEmployeeByEmailRequest
	(*GetEmployeeResponse)(nil),           // 25: user.GetEmployeeResponse
	(*UpdateEmployeeRequest)(nil),         // 26: user.UpdateEmployeeRequest
	(*GetEmployeesResponse_Employee)(nil), // 27: user.GetEmployeesResponse.Employee
}
var file_user_user_proto_depIdxs = []int32{
	16, // 0: user.GetClientsResponse.Clients:type_name -> user.Client
	27, // 1: user.GetEmployeesResponse.employees:type_name -> user.GetEmployeesResponse.Employee
	23, // 2: user.UserService.GetEmployeeById:input_type -> user.GetEmployeeByIdRequest
	24, // 3: user.UserService.GetEmployeeByEmail:input_type -> user.GetEmployeeByEmailRequest
	21, // 4: user.UserService.GetEmployees:input_type -> user.GetEmployeesRequest
	26, // 5: user.UserService.UpdateEmployee:input_type -> user.UpdateEmployeeRequest
	7,  // 6: user.UserService.Login:input_type -> user.LoginRequest
	5,  // 7: user.UserService.Logout:input_type -> user.LogoutRequest
	2,  // 8: user.UserService.Refresh:input_type -> user.RefreshRequest
	0,  // 9: user.UserService.ValidateAccessToken:input_type -> user.ValidateTokenRequest
	0,  // 10: user.UserService.ValidateRefreshToken:input_type -> user.ValidateTokenRequest
	9,  // 11: user.UserService.RequestPasswordReset:input_type -> user.PasswordActionRequest
	9,  // 12: user.UserService.RequestInitialPasswordSet:input_type -> user.PasswordActionRequest
	11, // 13: user.UserService.SetPasswordWithToken:input_type -> user.SetPasswordWithTokenRequest
	14, // 14: user.UserService.CreateClientAccount:input_type -> user.CreateClientRequest
	17, // 15: user.UserService.GetClients:input_type -> user.GetClientsRequest
	19, // 16: user.UserService.UpdateClient:input_type -> user.UpdateClientRequest
	13, // 17: user.UserService.CreateEmployeeAccount:input_type -> user.CreateEmployeeRequest
	25, // 18: user.UserService.GetEmployeeById:output_type -> user.GetEmployeeResponse
	25, // 19: user.UserService.GetEmployeeByEmail:output_type -> user.GetEmployeeResponse
	22, // 20: user.UserService.GetEmployees:output_type -> user.GetEmployeesResponse
	25, // 21: user.UserService.UpdateEmployee:output_type -> user.GetEmployeeResponse
	8,  // 22: user.UserService.Login:output_type -> user.LoginResponse
	6,  // 23: user.UserService.Logout:output_type -> user.LogoutResponse
	3,  // 24: user.UserService.Refresh:output_type -> user.RefreshResponse
	1,  // 25: user.UserService.ValidateAccessToken:output_type -> user.ValidateTokenResponse
	1,  // 26: user.UserService.ValidateRefreshToken:output_type -> user.ValidateTokenResponse
	10, // 27: user.UserService.RequestPasswordReset:output_type -> user.PasswordActionResponse
	10, // 28: user.UserService.RequestInitialPasswordSet:output_type -> user.PasswordActionResponse
	12, // 29: user.UserService.SetPasswordWithToken:output_type -> user.SetPasswordWithTokenResponse
	15, // 30: user.UserService.CreateClientAccount:output_type -> user.CreateClientResponse
	18, // 31: user.UserService.GetClients:output_type -> user.GetClientsResponse
	20, // 32: user.UserService.UpdateClient:output_type -> user.UpdateClientResponse
	25, // 33: user.UserService.CreateEmployeeAccount:output_type -> user.GetEmployeeResponse
